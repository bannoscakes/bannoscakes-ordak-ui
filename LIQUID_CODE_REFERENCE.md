# Working Liquid Code - 12 Months Production

## Purpose
This file contains the actual working Liquid code from Shopify that has been processing orders successfully for 12 months without failure.

This will be used as the SOURCE OF TRUTH to compare against the processor implementation.

## Paste the Liquid Code Below

```liquid
<!-- Paste your working Liquid code here -->


```

## Notes
- This code has been battle-tested in production
- Never failed in 12 months
- Correctly extracts all fields including flavours for gelato cakes
- This is what the processor should replicate exactly
<div class="wrapper">
  <div class="header">
