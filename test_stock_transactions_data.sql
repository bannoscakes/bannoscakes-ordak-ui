-- Test Stock Transactions Data for TransactionsInventory Component
...
-- First, let's get some component IDs for the transactions
-- We'll create transactions for different types of inventory movements
