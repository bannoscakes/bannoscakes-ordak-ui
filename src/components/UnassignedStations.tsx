    ...
    <Card className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        {stations.map((station, index) => {
          ...
          return (
            <div key={index} className="p-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 bg-white/70 dark:bg-white/20 backdrop-blur-md border border-white/20">
