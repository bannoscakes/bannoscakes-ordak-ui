        ...
        <CardHeader className="pb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-xl bg-pink-100 dark:bg-pink-950">
            ...
            {weekDays.map((day, index) => (
              <div key={index} className="flex flex-col border-r last:border-r-0">
                ...
                <div className="mb-4 text-center px-1">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-pink-100 dark:bg-pink-950 mb-2">
                    <div>
