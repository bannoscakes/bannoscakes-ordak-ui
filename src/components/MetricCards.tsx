  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[...Array(4)].map((_, i) => (
          <Card key={i} className="p-6 bg-white/70 dark:bg-white/30 md:backdrop-blur-md border border-white/20 shadow-md">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {displayMetrics.map((metric, index) => (
        <Card key={index} className="p-6 bg-white/70 dark:bg-white/30 md:backdrop-blur-md border border-white/20 shadow-md">
          <div className="flex items-start justify-between">
            <div className="space-y-2">
            ...
            <div className={`w-12 h-12 rounded-xl ${metric.bg} flex items-center justify-center border border-white/20`}>
