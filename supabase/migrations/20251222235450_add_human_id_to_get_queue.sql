-- Migration: Add human_id to get_queue RPC
-- Purpose: Queue views need to display #B12345 format but get_queue was missing human_id
-- Related: Issue #466, PR #465

BEGIN;

-- Drop and recreate get_queue with human_id column
...
COMMENT ON FUNCTION public.get_queue IS 'Get queue of orders with optional filtering. Includes human_id for #B12345/#F12345 display format.';
