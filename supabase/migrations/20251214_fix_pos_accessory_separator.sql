-- Fix POS accessory deduction: handle both "/" and "+" separators
-- POS orders use "+" separator: "Blue + Metallic"
-- Online orders use "/" separator: "Pink Glitter / 6"
...
'Deducts inventory when orders are inserted. Handles both online (/) and POS (+) separator formats for accessory variants.';
